...
export const foundationBass = () =>
  wavetable({
    oscA: { wave: "saw", morphTo: "triangle", position: 0.6 },
    oscB: { wave: "square", octave: 1, level: 0.35 },
    mix: 0.12,
    voiceMode: "mono",
    glide: 0.02,
    filter: { cutoff: 580, resonance: 0.03 },
...
export const turbineBass = () =>
  wavetable({
    oscA: { bank: "digital", position: 0.43, unison: 2, detune: 4, spread: 0.25 },
    oscB: { wave: "sine", octave: 2, level: 0 },
    mix: 0,
    fm: 0.16,
    voiceMode: "mono",
    glide: 0.025,
    filter: { cutoff: 6200, resonance: 0.06 },
    ...
    modulation: [
      { source: "modEnv", target: "fm", amount: 0.56 },
...
export const talkingBass = () =>
  wavetable({
    oscA: { bank: "vowel", position: 0.05 },
    oscB: { wave: "saw", octave: 1, level: 0.28 },
    mix: 0.12,
    voiceMode: "mono",
    filter: { cutoff: 6500, resonance: 0.08 },
    ...
    modulation: [
      { source: "modEnv", target: "positionA", amount: 0.9 },
...
export const laserBass = () =>
  wavetable({
    ...
    modulation: [
      { source: "modEnv", target: "warpA", amount: 0.55 },
      { source: "modEnv", target: "pitch", amount: 0.08 },
    ],
  });
export const snareClap = () =>
  wavetable({
    oscA: { level: 0 },
    noise: { level: 0.8 },
