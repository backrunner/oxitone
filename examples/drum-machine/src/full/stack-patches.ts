...
export const pulseChords = () => wavetable({
  oscA: { wave: "square", morphTo: "saw", position: 0.3, unison: 4, detune: 13, spread: 0.9, phaseSpread: 0.63 },
  oscB: { bank: "digital", position: 0.17, octave: 1, level: 0.2 }, mix: 0.12,
...
export const chordEdge = () => wavetable({
  oscA: { bank: "digital", position: 0.57 }, oscB: { wave: "saw", level: 0.55, octave: 0 }, mix: 0.3,
