...
export const skyChords = () =>
  wavetable({
    ...
    mix: 0.3,
    noise: { level: 0.013 },
    filter: { cutoff: 10500, resonance: 0.025 },
    ...
    lfo: { rateHz: 140 / 60 / 8, positionA: 0.025 },
    lfo2: { shape: "triangle", rateHz: 0.29 },
    modulation: [
      { source: "lfo2", target: "positionB", amount: 0.04 },
      { source: "velocity", target: "cutoff", amount: 0.055 },
      { source: "noteRandom", target: "pan", amount: 0.035 },
    ],
  });
export const chordBody = () =>
  wavetable({
...
export const horizonLead = () =>
  wavetable({
    ...
    modulation: [
      { source: "modEnv", target: "positionA", amount: 0.1 },
...
export const subBass = () =>
  wavetable({
    oscA: { level: 0 },
    oscB: { level: 0 },
    sub: { wave: "sine", octave: 0, level: 0.9 },
    voiceMode: "mono",
    amp: { attack: 0.005, decay: 0.1, sustain: 0.92, release: 0.045, releaseCurve: -0.4 },
  });
export const motionBass = () =>
  wavetable({
    oscA: {
      bank: "digital",
      position: 0.22,
    ...
    voiceMode: "mono",
    glide: 0.018,
    filter: { cutoff: 3800, resonance: 0.13 },
    ...
    lfo2: { shape: "triangle", rateHz: 140 / 60 },
    macros: [0.4],
    modulation: [
      { source: "modEnv", target: "positionA", amount: 0.55, curve: 0.3 },
      { source: "modEnv", target: "fm", amount: 0.32 },
      { source: "lfo2", target: "warpA", amount: 0.16 },
      { source: "macro1", target: "cutoff", amount: 0.1 },
    ],
  });
export const vowelBass = () =>
  wavetable({
    oscA: { bank: "vowel", position: 0.14, warpMode: "bend", warp: 0.2 },
    oscB: { wave: "sine", octave: 1 },
    mix: 0,
    fm: 0.06,
    filter: { cutoff: 5000, resonance: 0.08 },
...
export const skyPad = () =>
  wavetable({
    ...
    mix: 0.08,
    noise: { level: 0.007 },
    filter: { cutoff: 2100, resonance: 0.03 },
    amp: { attack: 0.6, decay: 0.3, sustain: 0.65, release: 0.7, attackCurve: -0.3 },
    lfo: { rateHz: 140 / 60 / 16, positionA: 0.2, cutoff: 3 },
  });
export const noiseFx = () =>
  wavetable({
    oscA: { level: 0 },
    noise: { level: 0.5 },
    filter: { type: "bandpass", cutoff: 3800, resonance: 0.07 },
...
export const downlifter = () =>
  wavetable({
    oscA: { level: 0 },
    noise: { level: 0.5 },
    filter: { type: "bandpass", cutoff: 2600, resonance: 0.05 },
...
export const reeseBass = () =>
  wavetable({
    oscA: { wave: "saw", unison: 3, detune: 12, spread: 0.24, phaseSpread: 0.43 },
    oscB: { wave: "square", octave: 0, level: 0.4 },
    mix: 0.14,
    voiceMode: "mono",
    glide: 0.04,
    filter: { cutoff: 780, resonance: 0.07 },
