...
import { checkConflict, checkProjectText, projectModified, projectSaveFiles, readProjectDisk } from "../files/project-disk.js";
...
export class ProjectDocument {
  ...
  private async pluginTask(revision: number, task: import("../plugins/plugin-lifecycle.js").PluginTask): Promise<DocumentView> {
    this.current(revision);
