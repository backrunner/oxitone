...
export const modulationSources = ["off", "lfo1", "lfo2", "ampEnv", "filterEnv", "modEnv",
  "velocity", "keytrack", "noteRandom", "macro1", "macro2", "macro3", "macro4"] as const;
export const modulationTargets = ["pitch", "cutoff", "positionA", "positionB", "warpA", "warpB",
  "fm", "ring", "mix", "pan", "level"] as const;
export const modulationRouteSchema = z.strictObject({
  source: z.enum(modulationSources), target: z.enum(modulationTargets),
