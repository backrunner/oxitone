...
export const projectFileSchema = projectSnapshotSchema.safeExtend({
  formatVersion: z.literal(PROJECT_FORMAT_VERSION),
  projectId: entityIdSchema,
}).refine((document) => document.projectId === document.id, { message: "projectId must equal snapshot id", path: ["projectId"] });
