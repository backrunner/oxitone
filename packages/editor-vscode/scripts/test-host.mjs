...
try {
  ...
  await build({
    ...
    format: "cjs",
    target: "node20",
    external: ["vscode", "@oxitone/cli/editor"],
  });
  await runTests({
    version: "1.96.4",
    cachePath: resolve("../../target/vscode-test"),
    extensionDevelopmentPath: process.cwd(),
    extensionTestsPath: resolve("dist/host.cjs"),
    extensionTestsEnv: {
      OXITONE_TEST_ROOT: root,
      OXITONE_TEST_NODE: process.execPath,
      OXITONE_TEST_SERVICE: resolve("scripts/test-service.mjs"),
      OXITONE_TEST_CLI: resolve("../cli/dist/index.js"),
      OXITONE_TEST_VIEWER: resolve("../../target/debug/oxitone-preview"),
    },
    launchArgs: [
      root,
      "--disable-extensions",
