...
only. Signed npm platform distribution and minimum-macOS runtime acceptance remain
release gates.
...
- Loop toggles the current range; **Loop selection** uses the selected clip's range.
